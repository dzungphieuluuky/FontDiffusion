...
def main():
    ...
    logger.info(f"  Style: {'Detailed (3-panel)' if args.detailed else 'Simple (2-panel)'}")
    logger.info(f"  Output: {'Display' if args.display else f'Save to {args.save_dir}'}")
    logger.info("=" * 80)
