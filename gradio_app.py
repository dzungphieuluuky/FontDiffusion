...
def run_fontdiffuer(
    source_image, character, reference_image, sampling_step, guidance_scale, batch_size
):
    ...
    out_image = sampling(
        args=args, pipe=pipe, content_image=source_image, style_image=reference_image
    )
    return out_image
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                gr.Examples(
                    examples=[
                        [
                            "figures/source_imgs/source_灨.jpg",
                            "figures/ref_imgs/ref_籍.jpg",
                        ],
                        [
                            "figures/source_imgs/source_鑻.jpg",
                            "figures/ref_imgs/ref_鹰.jpg",
                        ],
                        [
                            "figures/source_imgs/source_鑫.jpg",
                            "figures/ref_imgs/ref_壤.jpg",
                        ],
                        [
                            "figures/source_imgs/source_釅.jpg",
